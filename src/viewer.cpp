...
CWindowQueue ViewerWindowQueue("Sftp Viewers"); // list of all viewer windows
CThreadQueue ThreadQueue("Sftp Viewers");       // list of all viewer window threads
...
{
  // Sftp does not use 'viewerData'; otherwise the values would have to be passed
                                    ...
                                    int enumFilesSourceUID, int enumFilesCurrentIndex)
{
    ...
    // Sftp does not use 'viewerData'; otherwise we would pass the values (not references)
